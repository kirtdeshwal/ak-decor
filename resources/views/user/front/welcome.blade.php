@extends('user.layouts.app', ['activePage' => 'home', 'titlePage' => __('AK Collections')])
        ...
        <div class="row property__gallery">
            <div class="col-lg-3 col-md-4 col-sm-6 mix women">
                <div class="product__item">
                    ...
                    <div class="product__item__text">
                        <h6><a href="{{ url('product-details') }}">Buttons tweed blazer</a></h6>
                        <div class="rating">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix men">
                <div class="product__item">
                    ...
                    <div class="product__item__text">
                        <h6><a href="{{ url('product-details') }}">Flowy striped skirt</a></h6>
                        <div class="rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix accessories">
                <div class="product__item">
                    ...
                    <div class="product__item__text">
                        <h6><a href="{{ url('product-details') }}">Cotton T-Shirt</a></h6>
                        <div class="rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix cosmetic">
                <div class="product__item">
                    ...
                    <div class="product__item__text">
                        <h6><a href="{{ url('product-details') }}">Slim striped pocket shirt</a></h6>
                        <div class="rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix kid">
                <div class="product__item">
                    ...
                    <div class="product__item__text">
                        <h6><a href="{{ url('product-details') }}">Fit micro corduroy shirt</a></h6>
                        <div class="rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix women men kid accessories cosmetic">
                <div class="product__item sale">
                    ...
                    <div class="product__item__text">
                        <h6><a href="{{ url('product-details') }}">Tropical Kimono</a></h6>
                        <div class="rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix women men kid accessories cosmetic">
                <div class="product__item">
                    ...
                    <div class="product__item__text">
                        <h6><a href="{{ url('product-details') }}">Contrasting sunglasses</a></h6>
                        <div class="rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix women men kid accessories cosmetic">
                <div class="product__item sale">
                    ...
                    <div class="product__item__text">
                        <h6><a href="{{ url('product-details') }}">Water resistant backpack</a></h6>
                        <div class="rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
